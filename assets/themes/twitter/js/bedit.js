...
var U_I_E=true;// isimgha uyghurche kiremdu yoq? 
attachAll = true;
bedit_allow="" ;
bedit_deny="price:readperm:new_name:change_url_input:email:qq:icq:yahoo:msn:site:alipay:taobao:bdaynew:sitenew:icqnew:qqnew:yahoonew:alipaynew:taobaonew:msnnew:emailnew:seccodeverify";
/*":fastposturl_param_1:fastpostimg_param_1:fastpostimg_param_2:fastpostimg_param_3:e_url_param_1:e_tbl_param_1:e_tbl_param_2:e_tbl_param_3:e_tbl_param_4:e_image_param_1:e_image_param_2:e_image_param_3:e_aud_param_1:e_fls_param_1:e_fls_param_2:e_fls_param_3:e_cst1_qq_param_1"*/
if(U_I_E) bedit_deny=bedit_deny+":username:user_name:usernamenew";
//Bedit.js end